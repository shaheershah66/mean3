...
export default function Section4() {
  return (
    <div className="Section4 w-full my-[45px] mx-auto py-[62px] px-[20px] bg-[#F5F5F5]">
      <div className="section4-container w-full h-full flex justify-center">
        <div className="w-[330px] text-center text-[#535353]">
          <h1 className="text-[34px] font-bold text-[#DA2128] pb-2">
            Our Mission
          </h1>
          <p className="pb-[3%]">
        ...
        <div className="line h-[1px] w-[146px] bg-[#D7D7D7] border-[1px] rotate-90 mt-[6%] mx-[4%]"></div>
