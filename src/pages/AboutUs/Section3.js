  ...
  return (
    <div className="Section3 w-full">
      <div className="section3-container w-full text-center">
        <h1 className="text-[34px] font-bold mb-2">What does <span className="text-[#DA2128]">Mean</span> stands for?</h1>
        <p className="pb-[3%]">Mean3’s name is derived from a technology stack called ‘MeanStack’ Which means</p>
