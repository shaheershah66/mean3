...
export default function Section1(){
    ...
    return(
        <div className="Section1 w-full h-[550px] bg-cover bg-no-repeat" style={bgImage}>
            <div className="section1-container w-full h-full px-5 text-center flex items-center justify-center">
                <div className="flex flex-col items-center text-white">
                    ...
                    <p className="text-lg font-bold">Mean3 Has A Technological Mind And A Digital Heart</p>
                </div>
            </div>
        </div>
    )
