...
export default function Section4() {
  ...
  return (
    <div className="w-full Section4 p-[2%] mb-[4%] text-center" style={bgImage}>
      <div className="w-full section4-container">
        <h1 className="text-[34px] font-bold leading-[41px] text-white my-[0.67em]">
          Magento Solutions That We Offer
        </h1>
        <div className="pt-5 w-[90%] flex flex-wrap mb-[25px] justify-center mx-auto">
          {magentoSolutionsData.map(({title}) => {
            return (
              <div key={title} className="bg-white rounded-[10px] w-[20%] m-[5px] py-[15px] px-5">
