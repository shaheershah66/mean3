...
export default function Portfolio({bgImage, objectPosition, customer , altText}) {
    return (
        <div className="relative w-full h-full overflow-hidden section1-container font-open">
          <img
            className={`absolute top-0 left-0 items-center block object-cover w-full h-full ${objectPosition} -z-10`}
            src={bgImage} alt={altText}
          ></img>
          <div className="text-white top-auto bottom-[35px]  mx-auto w-[95%]  absolute left-1/2 -translate-x-1/2 -translate-y-1/2  md:w-[750px]  md:mt-0 lg:w-[970px] lg:top-1/2 lg:bottom-auto lg:mt-[70px] xl:w-[1170px]">
              ...
              <div className="flex flex-wrap">
                <h3 className="text-lg mb-2 lg:text-[32px] z-10  relative py-[15px] pr-[20px] -ml-[2000px] pl-[2000px] before:-z-10 before:skew-x-[20deg] text-right  before:rounded-r-lg inline-block before:content-[''] before:w-full before:h-full before:bg-black/[0.6] before:absolute before:left-0 before:top-0">
              ...
              <h3 className="relative font-[500] text-sm md:text-base py-[15px] pr-[16px] hidden xs:inline-block before:-skew-x-[20deg] before:-z-10 z-10 p-4 -ml-[2000px] pl-[2000px] text-right before:rounded-r-lg before:content-[''] before:w-full before:h-full before:bg-black/[0.4] before:absolute before:left-0 before:top-0">
