...
export default function Footer() {
  ...
  return (
    <div className="Footer w-full bg-[#2F2F2F] text-white py-5 font-open">
        ...
        <div className="flex flex-col w-full md:flex-row footer-top">
          <div className="w-full md:px-4 md:w-1/4 offices">
            ...
            <div>
              ...
              <h5 className="my-2">
                <a href="https://goo.gl/maps/YM7aZ1wjW3VutLzg6" className="hover:text-[#d5d5d5]" target="_blank" rel="noreferrer">
                  447 Broadway, 2nd Floor Suite #670, New York, New York 10013,
                  United States
                </a>
              </h5>
              <h5 className="mb-2 -mt-2">
                <a href="mailto:info@mean3.com" className="hover:text-[#d5d5d5]">info@mean3.com</a>
              </h5>
              <h5 className="mb-2 -mt-2">
                <a href="tel:+1(832)278-2928" className="hover:text-[#d5d5d5]">
                  +1 (832) 278-2928
                </a>
              </h5>
            </div>
            ...
            <div>
              ...
              <h5 className="my-2">
                <a className="hover:text-[#d5d5d5]" href="https://www.google.com/maps/place/Mean3+Pvt+Ltd/@24.8777607,67.0884744,15z/data=!4m5!3m4!1s0x0:0xfd1c01797a7a35da!8m2!3d24.8777682!4d67.0884694" target="_blank" rel="noreferrer">
              ...
              <h5 className="mb-2 -mt-2">
                <a href="tel:+923343257767" className="hover:text-[#d5d5d5]">+923343257767</a>
              </h5>
              <h5 className="mb-2 -mt-2">
                <a href="tel:+923314016473" className="hover:text-[#d5d5d5]">+923314016473</a>
              </h5>
            </div>
          </div>
          ...
          {footerData.map((item, index) => {
            return (
              <div className="w-full md:px-4 md:w-1/4 links" key={index}>
                <h4 className="mt-2 mb-[30px] text-[#d5d5d5] text-lg capitalize hover:text-[#d5d5d5]">
                  {item.title}
                </h4>
                <div>
                  <ul>
                    {item.links.map((link, linkIndex) => (
                      <li key={linkIndex}>
                        <Link to={link.url} className="block pb-1 capitalize hover:text-[#d5d5d5]">
                          {link.title}
                        </Link>
                      </li>
                    ))}
        ...
        <div className="footer-bottom w-full md:px-4 text-[13px]">
          ...
          <div className="flex flex-col-reverse w-full md:justify-between md:flex-row py-7">
            <p className="text-[#8b8c8d] md:mt-0 mt-5">
              ...
              <Link className="text-white hover:text-[#d5d5d5]" to="/">
                Mean3 Pvt Ltd
              </Link>
            </p>
