          ...
          <div className="header-first w-full flex items-center h-[46px] text-xs">
            <div className="header-inner-first-icons">
              <ul className="flex">
                <li className="px-1">
                  <a
                    href="https://www.facebook.com/Mean3.web/"
                    target="_blank"
                ...
                <li className="px-1">
                  <a
                    href="https://www.linkedin.com/company/mean3"
                    target="_blank"
                    className="cursor-pointer"
                  >
                    <svg
                ...
                <li className="px-1">
                  <a
                    href="https://www.instagram.com/mean3.pvt.ltd/"
                    target="_blank"
                    className="cursor-pointer"
                  >
                    <svg
                ...
                <li className="px-1">
                  <a
                    href="https://www.youtube.com/@Mean3"
                    target="_blank"
                    className="cursor-pointer"
                  >
                    <svg
